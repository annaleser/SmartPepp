...
#delay = -2.6666666666666\cdot10^{-15}\cdot x^{4}+1.0666666666666\cdot10^{-11}\cdot x^{3}-1.333333333333\cdot10^{-8}\cdot x^{2}+5.333333333333\cdot10^{-6}\cdot x
...
delay = .0005
for i in range(1000):
    delay = -4.2666666666666*(10**-14)*((i/2.0)**4)+8.533333333333*(10**-11)*(i**3)-5.333333333333*(10**-8)*(i**2)+0.0000106667*i
    print(delay)
