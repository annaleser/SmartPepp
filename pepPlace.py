...
def twelveProgram():
  ...
  if(isRunning == False):
    print("12")
    twelve = threading.Thread(target=pepPizza, args=(0.0000603,0.0003444,0.0000803,0.0003751,22.58064516,197500))
    twelve.start()
...
def fourteenProgram():
  ...
  if(isRunning == False):
    print("14")
    fourteen = threading.Thread(target=pepPizza, args=(0.000055,0.0003347,0.0000661,0.0004185,30.96774194,21750))
    fourteen.start()
