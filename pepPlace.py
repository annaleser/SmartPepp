...
def fourteenProgram():
  ...
  if(isRunning == False):
    print("14")
    fourteen = threading.Thread(target=pepPizza, args=(0.0000515,0.0002613,0.0000552,0.00009273,25,23000))
    fourteen.start()
...
def pepPizza(mSpin,bSpin,mMove,bMove,totalTime,reps):
  ...
  slice(20)
  spin(0,mSpin*totalTime*(5/4)+bSpin)
  move(IN,mMove,bMove+3*totalTime/5*mMove)
