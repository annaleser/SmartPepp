...
def fourteenProgram():
  ...
  if(isRunning == False):
    print("14")
    fourteen = threading.Thread(target=pepPizza, args=(-0.0000378,0.000876,-0.0000558,0.00124,13.33333,22500))
    fourteen.start()
...
def pepPizza(mSpin,bSpin,mMove,bMove,totalTime,reps):
  ...
  oneRevIn(.000749,3400,3000)
  oneRevIn(.000649,3300,3000)
  oneRevIn(.000549,3200,3000)
  oneRevIn(.000449,3100,3000)
  stopAll()
  back()
